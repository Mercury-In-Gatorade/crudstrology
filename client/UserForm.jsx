...
const UserForm = () => {
  ...
  const onSubmit = (data) => {
    //console.log(data);
    const {hobbies, interests, personalDetails, profession, vices, virtues} = data;
    ...
    the information, do not repeat back the information you have been told, do not make suggestions, moralize or give advice just tell them the future, ${JSON.stringify(data)} the users sign astrological sing is ${sign}`;
    console.log(content);
